...
// Reverted logic: remove @s.whatsapp.net first, then .txt
function cleanFileName(fileName: string): string {
  ...
  console.log(`EF cleanFileName (fetch-sheet-data - Reverted Logic): Original "${fileName}" -> Cleaned "${cleaned}"`); // Added log
