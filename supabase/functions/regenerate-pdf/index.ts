...
function cleanFileName(fileName: string): string {
  ...
  console.log(`EF cleanFileName (regenerate-pdf - New Logic): Original "${fileName}" -> Cleaned "${cleaned}"`); // Added log
...
serve(async (req) => {
  ...
  try {
    ...
    console.log(`Attempting to fetch sheet data for cleaned fileName (New Logic): ${cleanedFileName}`);
